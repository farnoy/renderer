...
impl ExampleBase {
    ...
    pub fn new(window_width: u32, window_height: u32) -> Self {
        ...
        unsafe {
            ...
            let surface_loader = Surface::new(entry.vk(), instance.vk()).expect(
                "Unable to load the Surface extension",
            );
            ...
            let device = device::Device::new(&instance, pdevice, queue_family_index as u32)
                .unwrap();
