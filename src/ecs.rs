...
pub(crate) mod systems {
    ...
    pub(crate) fn shift_runtime_config(
        mut runtime_config: ResMut<RuntimeConfiguration>,
        mut future_configs: ResMut<FutureRuntimeConfiguration>,
    ) {
    ...
    impl Gui {
        ...
        pub(crate) fn update<'a>(
            ...
            scope!("gui::update");
            let runtime_config = &mut runtime_config.0[1];
